...
import { isValidPos, showNextTetromino, tetrisResize, moveOnClickLeft, moveOnClickRight, rapidFallDown, rotateOnClickUp, showGameMessage, shuffle } from "./utils.js"
...
const app = (difficulty) => {
  ...
  bottomArrow.addEventListener('click', () => rapidFallDown(tetromino, playArea, placeTetromino))
